...
class FlakeIdGenerator {
    constructor(shard_id, epoch) {
        this.shard_id = shard_id;
        this.lastTime = Date.now();
        this.sequence_id = 0;
        this.epoch = epoch || 0;
    }
    nextStr(type_id, time) {
...
var flakeIdGenerator = new FlakeIdGenerator(config_1.server_config.instance_id);
exports.flakeIdGenerator = flakeIdGenerator;
